...
export class MyHoursPage implements OnInit {
    @ViewChild(IonModal)
    modal!: IonModal;
 ...
 async getdata() {
  ...
  this.redditService.addPost("profil", data).subscribe(data=>{
    console.log(data);
      ...
      this.monday= data.user.monday;

      this.tuesday= data.user.tuesday;
      this.wednesday= data.user.wednesday;
      this.thursday= data.user.thursday;
      this.friday= data.user.friday;
      this.saturday= data.user.saturday;
      this.sunday= data.user.sunday;
