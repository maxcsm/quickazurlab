...
@Component({
  ...
  templateUrl: './file-new.page.html',
  styleUrls: ['./file-new.page.scss'],
})
export class FileNewPage implements OnInit {
...
async doSave() {
  ...
  onFileSelected(event: any): void {
    ...
    this.http.post('https://api.biznextconnect.fr/api/uploadfile', formData)
    .subscribe((response) => {
